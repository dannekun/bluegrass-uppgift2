...
public class ON001_WeatherDataV1 extends RouteBuilder {
    ...
    public void configure() throws Exception {
        ...
        from("timer:{{log-inpoint}}?period=2000").setHeader(Exchange.HTTP_METHOD, simple("GET"))
                .log("Hämtar lufttemp")
